...
//AutonomousDrone::AutonomousDrone(std::shared_ptr<ctello::Tello>, std::string, std::string, const string&, std::string, bool, std::string&, bool, int, bool, bool, bool, std::string)
...
//std::pair<int, bool> AutonomousDrone::getRotationToFrameAngle(const Point &point, bool first=false)
