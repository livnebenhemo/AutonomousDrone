...
uint get_time_diff(std::chrono::steady_clock::time_point start, std::chrono::steady_clock::time_point end)
{
...
void Frame::ExtractORB(int flag, const cv::Mat &im)
{
    ...
    if(flag==0){
        ...
        // orb->detectAndCompute(im, cv::Mat(), mvKeys, mDescriptors);
    else
        (*mpORBextractorRight)(im,cv::Mat(),mvKeysRight,mDescriptorsRight);
    //auto end = get_time();

    //std::cout << "Time: " << get_time_diff(start, end) << " Size: " << mvKeys.size() << "\n";
...
// cv::Point2f undistort_pnt(cv::Point2f pnt)
// {

//     // const float fx = 183.31992593333334;
//     // const float px = 320.1701253333333;
//     // const float fy = 184.10304770000002;
//     // const float py = 236.16727703333333;
//     const float fx = 5.499597778e+02*1280/1920;
//     const float px = 9.605103760e+02*1280/1920;
//     const float fy = 5.523091431e+02*720/1440;
//     const float py = 7.085018311e+02*720/1440;

//     const float w = 7.159144282e-01;
//     float x = pnt.x;
//     float y = pnt.y;
...
void Frame::UndistortKeyPoints()
{
    ...
    for(int i=0; i<N; i++)
    {
        ...
        // cv::Point2f undist_pnt = undistort_pnt(kp.pt);
        // kp.pt = undist_pnt;
