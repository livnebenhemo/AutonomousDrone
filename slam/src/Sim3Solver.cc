...
Sim3Solver::Sim3Solver(KeyFrame *pKF1, KeyFrame *pKF2, const std::vector<std::shared_ptr<MapPoint>> &vpMatched12, const bool bFixScale):
    mnIterations(0), mnBestInliers(0), mbFixScale(bFixScale)
{

    auto vpKeyFrameMP1 = pKF1->mvpMapPoints;
...
void Sim3Solver::Project(const std::vector<cv::Mat> &vP3Dw, std::vector<cv::Mat> &vP2D, const cv::Mat& Tcw, cv::Mat K)
{
