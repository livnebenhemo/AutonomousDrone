...
namespace ORB_SLAM2 {
    ...
    Sim3Solver::Sim3Solver(KeyFrame *pKF1, KeyFrame *pKF2, const std::vector<std::shared_ptr<MapPoint>> &vpMatched12,
    ...
    void
    Sim3Solver::Project(const std::vector<cv::Mat> &vP3Dw, std::vector<cv::Mat> &vP2D, const cv::Mat &Tcw, cv::Mat K) {
