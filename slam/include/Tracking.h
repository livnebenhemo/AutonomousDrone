...
public:
    Tracking(System* pSys, std::shared_ptr<ORBVocabulary>  pVoc, FrameDrawer* pFrameDrawer, MapDrawer* pMapDrawer, Map* pMap,
             std::shared_ptr<KeyFrameDatabase>  pKFDB, const std::string &strSettingPath, const int sensor, const bool bReuse);
