...
namespace ORB_SLAM2 {
    ...
    public:
        ...
        int SearchByProjection(Frame &F, const std::vector<std::shared_ptr<MapPoint>> &vpMapPoints, const float th = 3) const;
        ...
        int SearchByBoW(KeyFrame *pKF, Frame &F, std::unordered_map<size_t, std::shared_ptr<MapPoint>> &vpMapPointMatches);
        ...
        static int Fuse(KeyFrame *pKF, std::unordered_map<size_t, std::shared_ptr<MapPoint>> &vpMapPoints, const float th = 3.0);

        // Project MapPoints into KeyFrame using a given Sim3 and search for duplicated MapPoints.
        static int Fuse(KeyFrame *pKF, const cv::Mat &Scw, const std::vector<std::shared_ptr<MapPoint>> &vpPoints, float th,
